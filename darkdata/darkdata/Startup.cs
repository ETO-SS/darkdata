...
using darkdata.ViewModels;
using darkdata.Helpers;
using darkdata.Authorization;
...
namespace darkdata
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("darkdata"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "darkdata API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "darkdata API V1");
            });
